    ...
    return (
        <Fragment>
            ...
            <Modal
                ...
                onRequestClose={ () => setModal02IsOpen(false) }    //  바깥에 눌렀을 때, 닫히게
            ...
            <Modal
                ...
                shouldCloseOnOverlayClick={ false }  //  onRequestClose, shouldCloseOnOverlayClick 거의 똑같 (바깥에 눌렀을 때임)
