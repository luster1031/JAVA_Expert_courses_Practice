...
<script src="https://code.jquery.com/ui/1.13.1/jquery-ui.js"></script>	<!-- Dialog -->
<script>
	...
	$("#btn-checkemail").click(function(){
		...
		$.ajax({
			...
			,success:function(response){
				...
				if(response.data){
					messageBox("이메일 중복","존재하는 이메일입니다.다른 이메일을 사용해 주세요",function(){
						$("#email").val("").focus();
					});					
					return;
				}
			...
			,error:function(xhr, status, e){
				console.error(status, e);	//	Unexpected token < in JSON : jsp로 보내서 파싱 에러남
			}
		});
	});
})
